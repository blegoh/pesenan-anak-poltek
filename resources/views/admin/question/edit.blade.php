            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="post" action="{{route('question.update',['id' => $question->id])}}">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Pertanyaan:</label>
                                <div class="col-sm-8">
                                    <textarea name="question" id="" cols="30" rows="10" class="form-control">{{$question->question}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="conclusion-form">
                                ...
                                <div class="col-sm-8">
                                    <select name="conclusion_yes" id="conclusion" class="form-control">
                                        <option value=""></option>
                                        <option @if($question->conclusion_yes == 1) selected @endif value="1">Ya</option>
                                        <option @if(!is_null($question->conclusion_yes) && $question->conclusion_yes == 0) selected @endif value="0">Tidak</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" id="conclusion-form">
                                ...
                                <div class="col-sm-8">
                                    <select name="conclusion_no" id="conclusion" class="form-control">
                                        <option value=""></option>
                                        <option @if($question->conclusion_no == 1) selected @endif value="1">Ya</option>
                                        <option @if(!is_null($question->conclusion_no) && $question->conclusion_no == 0) selected @endif value="0">Tidak</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
